...
public class BubbleSortTest {
    ...
    void testEmptyArray() {
        Integer[] array = {};
        BubbleSort<Integer> bubbleSort = new BubbleSort<>();
        bubbleSort.sort(array); // Sorting an empty array should remain empty
    ...
    void testSingleElementArray() {
        Integer[] array = {5};
        BubbleSort<Integer> bubbleSort = new BubbleSort<>();
        bubbleSort.sort(array); // Sorting a single element array should remain the same
    ...
    void testSortedArray() {
        ...
        BubbleSort<Integer> bubbleSort = new BubbleSort<>();
        bubbleSort.sort(array); // Already sorted, should remain the same
    ...
    void testReverseOrderedArray() {
        ...
        BubbleSort<Integer> bubbleSort = new BubbleSort<>();
        bubbleSort.sort(array); // Should sort to ascending order
